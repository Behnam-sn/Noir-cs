...
public sealed class MovieTests
{
    ...
    [InlineData("Fantastic.Mr.Fox.2009.720p.10bit.6CH.x265.PSA.mkv", "Fantastic Mr. Fox.mkv", "Fantastic Mr. Fox (2009).mkv")]
    // [InlineData("Race to Witch Mountain (2009) BluRay 720p.mkv", "Race to Witch Mountain.mkv")]
    [InlineData("My.Neighbor.Totoro.A.K.A.Tonari.no.Totoro.1988.DUAL-AUDIO.JAP-ENG.720p.10bit.BluRay.2CH.x265.HEVC-PSA.mkv", "My Neighbor Totoro A.K.A. Tonari no Totoro.mkv", "My Neighbor Totoro A.K.A. Tonari no Totoro (1988).mkv")]
